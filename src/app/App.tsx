...
// Поженить бэк с фронотом( поправить бэк )

// Протестировать, создать пользователя для ИФТ, поправить адаптив

// Смотреть какие нужны правки и новый функионал перед релизом

// Начать готовить релиз
